    ...
    internal static class GeneratedResolverGetFormatterHelper
    {
        ...
        static GeneratedResolverGetFormatterHelper()
        {
            lookup = new global::System.Collections.Generic.Dictionary<global::System.Type, int>(7)
            {
                ...
                { typeof(global::ServerPrototype.Shared.StartBuildFarmConstructionPacket), 6 },
            };
        }
        ...
        internal static object GetFormatter(global::System.Type t)
        {
            ...
            switch (key)
            {
                ...
                case 6: return new MessagePack.Formatters.ServerPrototype.Shared.StartBuildFarmConstructionPacketFormatter();
                default: return null;
            }
        }
    }
...
namespace MessagePack.Formatters.ServerPrototype.Shared
{
    public sealed class StartBuildFarmConstructionPacketFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::ServerPrototype.Shared.StartBuildFarmConstructionPacket>
    {

        public void Serialize(ref global::MessagePack.MessagePackWriter writer, global::ServerPrototype.Shared.StartBuildFarmConstructionPacket value, global::MessagePack.MessagePackSerializerOptions options)
        {
            if (value == null)
            {
                writer.WriteNil();
            ...
            global::MessagePack.IFormatterResolver formatterResolver = options.Resolver;
            writer.WriteArrayHeader(2);
            global::MessagePack.FormatterResolverExtensions.GetFormatterWithVerify<Point>(formatterResolver).Serialize(ref writer, value.Point, options);
            writer.Write(value.ConstructionId);
        }

        public global::ServerPrototype.Shared.StartBuildFarmConstructionPacket Deserialize(ref global::MessagePack.MessagePackReader reader, global::MessagePack.MessagePackSerializerOptions options)
        {
            if (reader.TryReadNil())
            {
                return null;
            ...
            global::MessagePack.IFormatterResolver formatterResolver = options.Resolver;
            var length = reader.ReadArrayHeader();
            var __Point__ = default(Point);
            var __ConstructionId__ = default(int);
            ...
            for (int i = 0; i < length; i++)
            {
                ...
                {
                    case 0:
                        __Point__ = global::MessagePack.FormatterResolverExtensions.GetFormatterWithVerify<Point>(formatterResolver).Deserialize(ref reader, options);
                        break;
                    case 1:
                        __ConstructionId__ = reader.ReadInt32();
                        break;
                    default:
                        reader.Skip();
                        break;
            ...
            var ____result = new global::ServerPrototype.Shared.StartBuildFarmConstructionPacket(__Point__, __ConstructionId__);
            reader.Depth--;
            return ____result;
        }
    }
